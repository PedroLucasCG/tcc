...
Para melhor entendimento da construção de sistemas onde há processos remotos colaborando há o Teorema \en{CAP}. Este define um \en{tradeoff} entre consistência e disponibilidade em sistemas distribuídos não confiáveis. Apresentado por Eric Brewer através de um exemplo generalista de serviço \en{web} para demonstrar essa troca entre disponibilidade, consistência e tolerância a partição. Consistência sendo a capacidade do serviço de retornar a resposta correta para uma requisição; Disponibilidade é a garantia de toda requisição receber uma resposta, mesmo que eventualmente; e, tolerância a partição, este é a capacidade serviço de permanecer funcionando mesmo no caso de perda de comunicação \cite{CAPtheorem2012}.
